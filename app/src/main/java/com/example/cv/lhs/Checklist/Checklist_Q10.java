...
public class Checklist_Q10 extends AppCompatActivity {
    Context ctx= Checklist_Q10.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q10);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_10_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_10_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_10_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_10_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_10_5);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_10_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_10_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_10_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_10_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_10_5);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q10.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question10 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question10 set " +
                                "question10_q1 = '" + result_q1 + "', " +
                                "question10_q2 = '" + result_q2 + "', " +
                                "question10_q3 = '" + result_q3 + "', " +
                                "question10_q4 = '" + result_q4 + "', " +
                                "question10_q5 = '" + result_q5 + "', " +
                                "question10_count = '" + count + "', " +
                                "question10_no_count = '" + no_count + "', " +
                                "question10_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question10(activity_id, result_q1, result_q2, result_q3, result_q4, result_q5, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q11.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question10 where activity_id = '" + activity_id + "'");
