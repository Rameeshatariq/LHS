...
import com.example.cv.lhs.AppController;
import com.example.cv.lhs.Checklist_Validation_Button;
...
import static com.example.cv.lhs.MainActivity.login_useruid;

public class PreviousActivities_Adapter extends BaseAdapter {
    private Context ctx;
    ...
    // Constructor
    public PreviousActivities_Adapter(Context ctx, ArrayList<String> activity, ArrayList<String> arrayListDate, ArrayList<String> arrayListId,
    ...
    public View getView(final int pos, View row, ViewGroup viewGroup) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_previous_activities_lv_layout, null);
            holder1.previous_list_background = row.findViewById(R.id.rl_background);
            holder1.rl_left_topbottomcorner = (RelativeLayout) row.findViewById(R.id.rl_left_topbottomcorner);
            holder1.previous_activities_lv_activity = row.findViewById(R.id.activityname);
            holder1.previous_activities_lv_date = row.findViewById(R.id.activitydate);
            holder1.previous_activities_lv_id= row.findViewById(R.id.activity_id);
            holder1.execute= row.findViewById(R.id.execute);
        ...
        try{
           ...
           /* String query2= "select activity_id, activity_month from Activities " +
            ...
            if(mdata != null){
                holder1.execute.setText("Execute");
                Log.d("000333", "if: "+mdata);
            }
            else{
                holder1.execute.setText("Prepare");
        ...
        if(holder1.activities_lv_status.getText().toString().equals("Completed")) {
            ...
            holder1.execute.setVisibility(View.GONE);
        }



        //  uid= "4d15a7ae41da19b874e00ec764ce4104000690d32451bbd99778236da769cedf";
      //  uid= MainActivity.login_useruid;

        holder1.execute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (holder1.execute.getText().toString().equals("Execute")) {
                    if(holder1.activities_lv_status.getText().toString().equals("Completed")){
                        ...
                        intent.putExtra("activity_id", holder1.previous_activities_lv_id.getText().toString());
                        intent.putExtra("activity_month", activity_month.get(pos));
                        Log.d("000555", "onClick: " + holder1.previous_activities_lv_id.getText().toString());
                        ctx.startActivity(intent);
                    }
                } else if(holder1.execute.getText().toString().equals("Prepare")) {
                    try {
                        ...
                        handler0.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequestCount(holder1,pos, activity_month.get(pos), activity_year.get(pos));
                            }
                        }, 2500);
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequestLive_Birth(holder1,pos, activity_month.get(pos), activity_year.get(pos));
                                //  sendPostRequestCvacination(holder,pos, uid, activity_month.get(pos), activity_year.get(pos));
                        ...
                        handler2.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequestLow_Birth(holder1,pos, activity_month.get(pos), activity_year.get(pos));
                                //  sendPostRequestCvacination(holder,pos, uid, activity_month.get(pos), activity_year.get(pos));
                        ...
                        handler3.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                //  sendPostRequestCvacination(holder,pos, uid, activity_month.get(pos), activity_year.get(pos));
                                sendPostRequestNew_Preg(holder1,pos, activity_month.get(pos), activity_year.get(pos));
                            }
                        }, 2500);
                        ...
                        handler4.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                sendPostRequestTotal_Preg(holder1,pos, activity_month.get(pos), activity_year.get(pos));
                                //  sendPostRequestCvacination(holder,pos, uid, activity_month.get(pos), activity_year.get(pos));
                            }
                        }, 2500);
        ...
        if (pos % 2 == 0) {
            ...
            holder1.previous_list_background.setBackgroundColor(ctx.getResources().getColor(R.color.light_pink_color));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder1.rl_left_topbottomcorner.setBackgroundTintList(ctx.getResources().getColorStateList(R.color.hp_listview_textview_redcolor));
            }
        } else {

            holder1.previous_list_background.setBackgroundColor(ctx.getResources().getColor(R.color.color_white));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder1.rl_left_topbottomcorner.setBackgroundTintList(ctx.getResources().getColorStateList(R.color.hp_listview_textview_bluecolor));
            }
        }
...
*/
                        ...
                        if(mFlag){
                            ...
                            alertDialog.dismiss();
                            holder.execute.setText("Execute");
                            Toast.makeText(ctx, "Data not downloaded successfully, Please use Manual Option", Toast.LENGTH_LONG).show();
