...
public class Checklist_Q9 extends AppCompatActivity {
    Context ctx= Checklist_Q9.this;
    String activity_id,activity_month;
    CheckBox cb_yes_q1, cb_yes_q2, cb_yes_q3, cb_yes_q4, cb_no_q1, cb_no_q2, cb_no_q3, cb_no_q4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q9);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_9_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_9_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_9_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_9_4);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_9_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_9_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_9_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_9_4);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q9.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question9 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question9 set " +
                                "question9_q1 = '" + result_q1 + "', " +
                                "question9_q2 = '" + result_q2 + "', " +
                                "question9_q3 = '" + result_q3 + "', " +
                                "question9_q4 = '" + result_q4 + "', " +
                                "question9_count = '" + count + "', " +
                                "question9_no_count = '" + no_count + "', " +
                                "question9_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question9(activity_id, result_q1, result_q2, result_q3, result_q4, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q10.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question9 where activity_id = '" + activity_id + "'");
