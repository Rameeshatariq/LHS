...
public class Checklist_Q12 extends AppCompatActivity {
    Context ctx= Checklist_Q12.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q12);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_12_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_12_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_12_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_12_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_12_5);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_12_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_12_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_12_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_12_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_12_5);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q12.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question12 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question12 set " +
                                "question12_q1 = '" + result_q1 + "', " +
                                "question12_q2 = '" + result_q2 + "', " +
                                "question12_q3 = '" + result_q3 + "', " +
                                "question12_q4 = '" + result_q4 + "', " +
                                "question12_q5 = '" + result_q5 + "', " +
                                "question12_count = '" + count + "', " +
                                "question12_no_count = '" + no_count + "', " +
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q13.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question12 where activity_id = '" + activity_id + "'");
