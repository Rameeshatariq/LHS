...
public class Checklist_Q14 extends AppCompatActivity {
    Context ctx= Checklist_Q14.this;
    String activity_id,activity_month;
    CheckBox cb_yes_q1, cb_yes_q2, cb_no_q1, cb_no_q2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q14);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_14_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_14_2);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_14_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_14_2);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q14.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question14 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question14 set " +
                                "question14_q1 = '" + result_q1 + "', " +
                                "question14_q2 = '" + result_q2 + "', " +
                                "question14_count = '" + count + "', " +
                                "question14_no_count = '" + no_count + "', " +
                                "question14_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question14(activity_id, result_q1, result_q2, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q15.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question14 where activity_id = '" + activity_id + "'");
