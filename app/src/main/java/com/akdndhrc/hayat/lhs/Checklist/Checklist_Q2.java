...
public class Checklist_Q2 extends AppCompatActivity {
    Context ctx= Checklist_Q2.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q2);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_2_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_2_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_2_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_2_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_2_5);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_2_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_2_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_2_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_2_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_2_5);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q2.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question2 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question2 set " +
                                "question2_q1 = '" + result_q1 + "', " +
                                "question2_q2 = '" + result_q2 + "', " +
                                "question2_q3 = '" + result_q3 + "', " +
                                "question2_q4 = '" + result_q4 + "', " +
                                "question2_q5 = '" + result_q5 + "', " +
                                "question2_count = '" + count + "', " +
                                "question2_no_count = '" + no_count + "', " +
                                "question2_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question2(activity_id, result_q1, result_q2, result_q3, result_q4, result_q5, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q3.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question2 where activity_id = '" + activity_id + "'");
