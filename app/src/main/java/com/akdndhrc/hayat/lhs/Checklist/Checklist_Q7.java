...
public class Checklist_Q7 extends AppCompatActivity {
    Context ctx= Checklist_Q7.this;
    String activity_id,activity_month;
    CheckBox cb_yes_q1, cb_yes_q2, cb_yes_q3, cb_yes_q4,cb_yes_q5, cb_yes_q6, cb_no_q1, cb_no_q2, cb_no_q3, cb_no_q4,
            cb_no_q5,cb_no_q6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q7);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_7_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_7_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_7_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_7_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_7_5);
        cb_yes_q6=(CheckBox)findViewById(R.id.checkbox_haan_7_6);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_7_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_7_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_7_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_7_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_7_5);
        cb_no_q6=(CheckBox)findViewById(R.id.checkbox_nahi_7_6);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q7.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question7 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question7 set " +
                                "question7_q1 = '" + result_q1 + "', " +
                                "question7_q2 = '" + result_q2 + "', " +
                                "question7_q3 = '" + result_q3 + "', " +
                                "question7_q4 = '" + result_q4 + "', " +
                                "question7_q5 = '" + result_q5 + "', " +
                                "question7_q6 = '" + result_q6 + "', " +
                                "question7_count = '" + count + "', " +
                                "question7_no_count = '" + no_count + "', " +
                                "question7_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question7(activity_id, result_q1, result_q2, result_q3, result_q4, result_q5,result_q6,count,no_count,na_count);
                        if(isInserted) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q8.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question7 where activity_id = '" + activity_id + "'");
