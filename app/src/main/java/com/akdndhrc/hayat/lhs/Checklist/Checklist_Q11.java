...
public class Checklist_Q11 extends AppCompatActivity {
    Context ctx= Checklist_Q11.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q11);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_11_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_11_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_11_3);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_11_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_11_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_11_3);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q11.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question11 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question11 set " +
                                "question11_q1 = '" + result_q1 + "', " +
                                "question11_q2 = '" + result_q2 + "', " +
                                "question11_q3 = '" + result_q3 + "', " +
                                "question11_count = '" + count + "', " +
                                "question11_no_count = '" + no_count + "', " +
                                "question11_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question11(activity_id, result_q1, result_q2, result_q3, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q12.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question11 where activity_id = '" + activity_id + "'");
