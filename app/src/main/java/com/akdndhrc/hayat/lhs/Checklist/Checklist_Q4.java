...
public class Checklist_Q4 extends AppCompatActivity {
    Context ctx= Checklist_Q4.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q4);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_4_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_4_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_4_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_4_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_4_5);
        cb_yes_q6=(CheckBox)findViewById(R.id.checkbox_haan_4_6);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_4_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_4_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_4_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_4_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_4_5);
        cb_no_q6=(CheckBox)findViewById(R.id.checkbox_nahi_4_6);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q4.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question4 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question4 set " +
                                "question4_q1 = '" + result_q1 + "', " +
                                "question4_q2 = '" + result_q2 + "', " +
                                "question4_q3 = '" + result_q3 + "', " +
                                "question4_q4 = '" + result_q4 + "', " +
                                "question4_q5 = '" + result_q5 + "', " +
                                "question4_q6 = '" + result_q6 + "', " +
                                "question4_count = '" + count + "', " +
                                "question4_no_count = '" + no_count + "', " +
                                "question4_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question4(activity_id, result_q1, result_q2, result_q3, result_q4, result_q5,result_q6, count,no_count,na_count);
                        if(isInserted) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q5.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question4 where activity_id = '" + activity_id + "'");
