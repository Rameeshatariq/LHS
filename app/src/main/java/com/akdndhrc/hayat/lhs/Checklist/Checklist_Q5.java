...
public class Checklist_Q5 extends AppCompatActivity {
    Context ctx= Checklist_Q5.this;
    String activity_id,activity_month;
    CheckBox cb_yes_q1, cb_yes_q2, cb_yes_q3, cb_yes_q4,cb_yes_q5, cb_no_q1, cb_no_q2, cb_no_q3, cb_no_q4, cb_no_q5;
    String result_q1, result_q2, result_q3, result_q4, result_q5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q5);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_5_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_5_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_5_3);
        cb_yes_q4=(CheckBox)findViewById(R.id.checkbox_haan_5_4);
        cb_yes_q5=(CheckBox)findViewById(R.id.checkbox_haan_5_5);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_5_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_5_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_5_3);
        cb_no_q4=(CheckBox)findViewById(R.id.checkbox_nahi_5_4);
        cb_no_q5=(CheckBox)findViewById(R.id.checkbox_nahi_5_5);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q5.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question5 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question5 set " +
                                "question5_q1 = '" + result_q1 + "', " +
                                "question5_q2 = '" + result_q2 + "', " +
                                "question5_q3 = '" + result_q3 + "', " +
                                "question5_q4 = '" + result_q4 + "', " +
                                "question5_q5 = '" + result_q5 + "', " +
                                "question5_count = '" + count + "', " +
                                "question5_no_count = '" + no_count + "', " +
                                "question5_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question5(activity_id, result_q1, result_q2, result_q3, result_q4, result_q5, count,no_count,na_count);
                        if(isInserted) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q6.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question5 where activity_id = '" + activity_id + "'");
