...
public class Helper extends SQLiteOpenHelper {
    ...
    private static final String activity_hw_id = "health_worker_id";
    ...
    private static final String is_sync = "is_synced";
    private static final String is_sync_checklist = "is_synced_checklist";
    ...
    private static final String QUESTION4_Q6 = "question4_q6";
    ...
    public static String CREATE_TABLE_HIGH_RISK;
 ...
 /*  public Helper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTable0 = "CREATE TABLE " + TABLE_NAME_0 + "(" +
                ...
                "is_synced INTEGER(2) NULL, " +
                "is_synced_checklist INTEGER(2) NULL, " +
                "is_synced_validation INTEGER(2) NULL " +
                " )";
        ...
        CREATE_TABLE_HIGH_RISK = "CREATE TABLE high_risk( " +
                "id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," +
                "member_id varchar(50) NOT NULL UNIQUE," +
                "full_name varchar(50) NOT NULL," +
                "added_by varchar(50) NOT NULL," +
        ...
        db.execSQL(CREATE_TABLE_HIGH_RISK);
        ...
        CREATE_TABLE_VALIDATION = "CREATE TABLE validation( " +
                ...
                "is_validated varchar(2) NOT NULL," +
                "activity_id varchar(50) NOT NULL," +
                "is_synced varchar(2) NOT NULL," +
                " FOREIGN KEY (" + activity_id + ") REFERENCES  " + TABLE_NAME_0 + "(" + activity_id + "))";
    ...
    public boolean activities(String id, String date, String health, String healthcentre, String healthworker,String healthworker_id, String facility, String totalcount,
                              String month, String year, String status,String is_synced) {
        ...
        contentValues.put(activity_hw_id, healthworker_id);
        ...
        contentValues.put(is_sync,is_synced);
