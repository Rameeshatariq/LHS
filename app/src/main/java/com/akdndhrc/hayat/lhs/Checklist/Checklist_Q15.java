...
public class Checklist_Q15 extends AppCompatActivity {
    Context ctx= Checklist_Q15.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist__q15);
        ...
        cb_yes_q1=(CheckBox)findViewById(R.id.checkbox_haan_15_1);
        cb_yes_q2=(CheckBox)findViewById(R.id.checkbox_haan_15_2);
        cb_yes_q3=(CheckBox)findViewById(R.id.checkbox_haan_15_3);
        cb_no_q1=(CheckBox)findViewById(R.id.checkbox_nahi_15_1);
        cb_no_q2=(CheckBox)findViewById(R.id.checkbox_nahi_15_2);
        cb_no_q3=(CheckBox)findViewById(R.id.checkbox_nahi_15_3);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(Checklist_Q15.this, MainActivity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String[][] mData = ls.executeReader("Select * from Question15 where activity_id  = '" + activity_id + "'");

                    boolean isInserted;

                    if (mData != null) {
                        isInserted = ls.executeNonQuery("Update Question15 set " +
                                "question15_q1 = '" + result_q1 + "', " +
                                "question15_q2 = '" + result_q2 + "', " +
                                "question15_q3 = '" + result_q3 + "', " +
                                "question15_count = '" + count + "', " +
                                "question15_no_count = '" + no_count + "', " +
                                "question15_na_count = '" + na_count + "' " +
                        ...
                        isInserted = helper.question15(activity_id, result_q1, result_q2, result_q3, count,no_count,na_count);
                        if(isInserted){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent= new Intent(ctx, Checklist_Q16.class);
    ...
    public boolean isCompleted(String activity_id) {
        ...
        String[][] mData = lister.executeReader("Select * From Question15 where activity_id = '" + activity_id + "'");
